package com.example.catalogoapp.src.core.service.worker
...
import com.example.catalogoapp.src.core.workers.SyncRopaOperationsWorker
...
class NetworkMonitorService : Service() {
    ...
    companion object {
        ...
        const val ACTION_STOP_SERVICE = "com.example.catalogoapp.STOP_SERVICE"
    ...
    override fun onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            notificationManager.notify(NOTIFICATION_ID, getNotification("Monitoreando conexión..."))
        }
